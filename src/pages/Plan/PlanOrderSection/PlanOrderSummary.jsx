        ...
        <div className="order-summary">
            ...
            {disabled ? (
                <p className="order-summary-text">
                    'I drink coffee <span className='option-text'> {drink}</span>, with a
                    <span className='option-text'> {type}</span> type of bean.
                    <span className='option-text'> {quantity}</span>, sent to me
                    <span className='option-text'> {frequency}</span> .'
                </p>
            ) : (
                <p className="order-summary-text">'I drink coffee <span className='option-text'> {drink} </span>, with a
                    <span className='option-text'> {type} </span>type of bean.
                    <span className='option-text'> {quantity} </span> ground ala
                    <span className='option-text'> {grind} </span> , sent to me
                    <span className='option-text'> {frequency}</span> .'
                </p>
            )}
        </div>
