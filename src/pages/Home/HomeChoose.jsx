            ...
            <div className="home-choose">
                ...
                <div className="choose-container">
                    <div className="choose-card">
                        <img src="/public/assets/home/desktop/icon-coffee-bean.svg" alt="coffee bean icon" className="choose-card-image" />
                    ...
                    <div className="choose-card">
                        <img src="/public/assets/home/desktop/icon-truck.svg" alt="coffee bean icon" className="choose-card-image" />
                        <div className="choose-card-copy">
